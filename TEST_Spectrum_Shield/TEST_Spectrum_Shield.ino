...
const int SDI = 9; //Red wire (not the red 5V wire!)
const int CKI = 8; //Green wire
...
//You'll need one for each LED, we're using STRIP_LENGTH LEDs here.
...
void setup() {
  ...
  LP.initialize(25, &MyDisplay[0], STRIP_LENGTH, CKI, SDI );
